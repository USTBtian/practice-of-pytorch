...
path_lenet = os.path.abspath(os.path.join(BASE_DIR,  "lenet.py"))
path_tools = os.path.abspath(os.path.join(BASE_DIR,  "common_tools.py"))
...
# train_dir= os.path.abspath(os.path.join(BASE_DIR,"data","train"))
...
# train_data= DogOrCatDataset(data_dir=train_dir,transform=train_transform)
